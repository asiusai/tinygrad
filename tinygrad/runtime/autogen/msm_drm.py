...
class struct_drm_msm_gem_submit_cmd(c.Struct):
  ...
  iova: Annotated[Annotated[int, ctypes.c_uint64], 24]
@c.record
...
class struct_drm_msm_vm_bind_op(c.Struct):
  ...
  handle: Annotated[Annotated[int, ctypes.c_uint32], 4]
  obj_offset: Annotated[Annotated[int, ctypes.c_uint64], 8]
  iova: Annotated[Annotated[int, ctypes.c_uint64], 16]
  range: Annotated[Annotated[int, ctypes.c_uint64], 24]
...
class struct_drm_msm_vm_bind(c.Struct):
  SIZE = 88
  flags: Annotated[Annotated[int, ctypes.c_uint32], 0]
  nr_ops: Annotated[Annotated[int, ctypes.c_uint32], 4]
  fence_fd: Annotated[Annotated[int, ctypes.c_int32], 8]
  queue_id: Annotated[Annotated[int, ctypes.c_uint32], 12]
  in_syncobjs: Annotated[Annotated[int, ctypes.c_uint64], 16]
  out_syncobjs: Annotated[Annotated[int, ctypes.c_uint64], 24]
  nr_in_syncobjs: Annotated[Annotated[int, ctypes.c_uint32], 32]
  nr_out_syncobjs: Annotated[Annotated[int, ctypes.c_uint32], 36]
  syncobj_stride: Annotated[Annotated[int, ctypes.c_uint32], 40]
  op_stride: Annotated[Annotated[int, ctypes.c_uint32], 44]
  op: Annotated[struct_drm_msm_vm_bind_op, 48]
  ops: Annotated[Annotated[int, ctypes.c_uint64], 48]
@c.record
...
MSM_PARAM_RAYTRACING = 0x11 # type: ignore
MSM_PARAM_UBWC_SWIZZLE = 0x12 # type: ignore
MSM_PARAM_MACROTILE_MODE = 0x13 # type: ignore
MSM_PARAM_UCHE_TRAP_BASE = 0x14 # type: ignore
MSM_PARAM_HAS_PRR = 0x15 # type: ignore
MSM_PARAM_EN_VM_BIND = 0x16 # type: ignore
...
MSM_BO_NO_SHARE = 0x00000004 # type: ignore
...
MSM_BO_FLAGS = (MSM_BO_SCANOUT | MSM_BO_GPU_READONLY | MSM_BO_NO_SHARE | MSM_BO_CACHE_MASK) # type: ignore
...
MSM_SYNCOBJ_RESET = 0x00000001 # type: ignore
MSM_SYNCOBJ_FLAGS = ( MSM_SYNCOBJ_RESET | 0) # type: ignore
...
MSM_VM_BIND_OP_UNMAP = 0 # type: ignore
MSM_VM_BIND_OP_MAP = 1 # type: ignore
MSM_VM_BIND_OP_MAP_NULL = 2 # type: ignore
MSM_VM_BIND_OP_DUMP = 1 # type: ignore
MSM_VM_BIND_OP_FLAGS = ( MSM_VM_BIND_OP_DUMP | 0) # type: ignore
MSM_VM_BIND_FENCE_FD_IN = 0x00000001 # type: ignore
MSM_VM_BIND_FENCE_FD_OUT = 0x00000002 # type: ignore
MSM_VM_BIND_FLAGS = ( MSM_VM_BIND_FENCE_FD_IN | MSM_VM_BIND_FENCE_FD_OUT | 0) # type: ignore
...
MSM_SUBMITQUEUE_ALLOW_PREEMPT = 0x00000001 # type: ignore
MSM_SUBMITQUEUE_VM_BIND = 0x00000002 # type: ignore
MSM_SUBMITQUEUE_FLAGS = ( MSM_SUBMITQUEUE_ALLOW_PREEMPT | MSM_SUBMITQUEUE_VM_BIND | 0) # type: ignore
...
DRM_MSM_VM_BIND = 0x0D # type: ignore
...
DRM_IOCTL_MSM_VM_BIND = DRM_IOWR(DRM_COMMAND_BASE + DRM_MSM_VM_BIND, struct_drm_msm_vm_bind) # type: ignore